    ...
    $("#content").append(
        $(`
            <div class="aboutContainer">
                ...
                <hr>
                <p>
                    Petite application de gestion de favoris pour le labo 01 réaliser
                    dans le cadre du cours KBG
                </p>
                <p>
                    Auteur: Kéven B Boisclair
                </p>
                <p>
        ...
        <div class="bookmarkdeleteForm">
            ...
            <div class="bookmarkRow" bookmark_id=${bookmark.Id}">
                <div class="bookmarkContainer">
                    <div class="bookmarkLayoutTop">
                        <img class="urlFavicon" src="http://www.google.com/s2/favicons?sz=64&domain=${bookmark.Url}" alt="Bookmark Icon">
                        <span class="bookmarkTitle">${bookmark.Title}</span>
                    </div>
                    <br>
                    <div class="bookmarkLayoutBottom">
...
function renderBookmarkForm(bookmark = null) {
    ...
    $("#content").append(`
        <form class="form" id="bookmarkForm">
            ...
            />
            <label for="Url" class="form-label">Hyperlien </label>
            <input
                ...
                required
                RequireMessage="Veuillez entrer l'hyperlien" 
                InvalidMessage="Veuillez entrer un hyperlien valide"
                value="${bookmark.Url}" 
            />
